import type { FileCategory, StarType } from '@shared/types'

export function defaultStarType(name: string, mimeType: string, category: FileCategory): StarType | null {
  ...
  if (ext === '.md' || ext === '.markdown' || ext === '.mdx') return null
