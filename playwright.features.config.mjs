...
export default { ...config, testMatch: process.env.STARPALACE_FULL_BROWSER ? undefined : ['releaseFeatures.spec.ts', 'solarSystem.spec.ts', 'browsingFixes.spec.ts'], use: { ...config.use, baseURL: 'http://127.0.0.1:5178' }, webServer: [
